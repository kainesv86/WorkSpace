                ...
                <React.Fragment>
                        <div className="relative z-10 flex items-center justify-between w-full h-20 px-4 bg-amber-400 sm:px-8">
                                                        ...
                                                        >
                                                                <Link to={item.path}>
                                                                        <div className="flex flex-col justify-end h-full">
                                                                                ...
                                                                                <span
                                                                                        className={`block w-full h-1 mt-6 ${
                                                                                                location === item.path
                                                                                                        ? "bg-amber-600"
                                                                                                        : "bg-amber-400"
                                                                                        }`}
                                ...
                                <div className="sm:hidden">
                                        ...
                                        >
                                                {!burger ? (
                                                        <img src="/share/burger.svg" alt="" />
                                                ) : (
                                                        <img src="/share/close.svg" alt="" />
                                                )}
                                        </div>
                                </div>
                        </div>
                        {burger ? (
                                <div className="absolute top-0 right-0 z-0 flex flex-col justify-between min-h-screen bg-amber-300 w-80">
